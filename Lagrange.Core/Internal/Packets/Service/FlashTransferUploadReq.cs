...
{
    [ProtoMember(1)] public uint FileId { get; set; } // 0
    ...
    [ProtoMember(3)] public uint UploadIndex { get; set; }
...
{
    [ProtoMember(1)] public byte[] FileId { get; set; } // Empty
    ...
    [ProtoMember(101)] public FlashTransferUploadFileBinding? FileBinding { get; set; }
}
